...
async findAll(
  ...
  const qb = this.userRepository
    ...
    .leftJoinAndSelect('user.parent_agent', 'parent_agent')
...
if (format === 'xlsx') {
  ...
  async createFromPortal(dto: {
    ...
    const { username, password, email, companyCode, agent_code } = dto;
    ...
    // 處理代理商分配邏輯
    let parentAgent: User | null = null;
